...
test_lex '6.4.9 #3 Example' '#include "//e"'    '(#include)ws( )str_lit("//e")\n'
...
#/
#)"
test_lex "? cpp (#include h-chars)" '#include "<foo>"' '(#include)ws( )str_lit("<foo>")\n'
test_lex "? cpp (#include q-chars)" '#include <"foo">' '(#include)ws( )(<)str_lit("foo")(>)\n'
test_lex "? macro lone #" "#" '(#)\n'
#test_lex "? macro # and \\" "#\\
#" "cpp(#\\
#
