...
declaration_specifier
  : storage_class_specifier { ("storage_class_specifier", $1) }
  | type_specifier { printf "type_specifier: %s\n" $1; ("type", $1) }
  | type_qualifier { ("type_qualifier", $1) }
  | function_specifier { ("function_specifier", $1) }
  ;
...
type_specifier
  ...
  | COMPLEX   { "complex" }
  | IMAGINARY { "imaginary" }
  | struct_or_union_specifier { ("struct_or_union_specifier", $1) }
  | enum_specifier { ("enum_specifier", $1) }
  | typedef_name { ("typedef_name", $1) }
  ;
